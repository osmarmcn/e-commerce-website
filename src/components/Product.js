...
const Product = ({product}) => {
  ...
  return(
    <div>
      <div className='border border -[#e4e4e4] h-[300px] mb-4 relative ocerflow-hidden group transition'>
...
/*
<div className='w-full h-[300px] bg-gray-200' key={product.id}>
              {product.title}
  </div>
*/